...
**TOGAF** (The Open Group Architecture Framework) serves as the primary structural reference. We use TOGAF's Architecture Development Method (ADM), content metamodel, and capability framework as the baseline against which we assess what changes when AI agents become first-class participants in the enterprise.
...
- **Grounded in TOGAF**: All analysis anchored to established TOGAF concepts and structure
